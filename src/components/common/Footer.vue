      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><router-link to="/exhibition" class="text-gray-400 hover:text-white transition-colors">数学展</router-link></li>
            <li><router-link to="/products" class="text-gray-400 hover:text-white transition-colors">产品中心</router-link></li>
            <li><router-link to="/faq" class="text-gray-400 hover:text-white transition-colors">常见问题</router-link></li>
